...
;---------------------------------------------------------------------------
;Flame Airstrike
[State -1, Flame Airstrike]
type = ChangeState
value = 880
triggerall = power >= 1000
triggerall = command = "FlameAirstrike"
triggerall = !IsHelper
trigger1 = statetype = S
trigger1 = ctrl
...
;---------------------------------------------------------------------------
;Shadow Clone
[State -1, Shadow Clone]
type = ChangeState
value = 890
triggerall = power >= 1000
triggerall = command = "ShadowClone"
triggerall = !IsHelper ;<-- this is very important bruh
triggerall = var(5) = 0
trigger1 = statetype = S
trigger1 = ctrl
